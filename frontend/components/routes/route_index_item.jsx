  ...
  render() {
    ...
    return (
      <tr className='route_index_item' onClick={ this.handleClick }>
        <td className='route_map_container'><img src={ staticMap }/></td>
        <td className='route_index_item_date'>{ route.date }</td>
        <td className='route_index_item_distance'>{ route.distance + " mi"}</td>
